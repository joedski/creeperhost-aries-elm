...
Since CreeperHost doesn't add CORS headers to their API responses, it generally cannot be used in a web browser.  Since Elm is a UI language, it generally canont be used in a server.  So, this library is basically only for [nw.js][] projects.
